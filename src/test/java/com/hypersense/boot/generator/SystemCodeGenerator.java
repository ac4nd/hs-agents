package com.hypersense.boot.generator;
...
public class SystemCodeGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:postgresql://localhost:5432/godlikeagents_admin_tenant?currentSchema=public", "postgres", "123456");
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create(DATA_SOURCE_CONFIG)
                ...
                .packageConfig(builder -> {
                            builder
                                    .parent("com.hypersense.boot.system")
                                    .entity("model.entity")
                                    .mapper("mapper")
                                    .service("support")

package com.hypersense.boot.framework.security.config;

import com.hypersense.boot.framework.captcha.service.CaptchaService;
import cn.hutool.core.util.ArrayUtil;
import com.hypersense.boot.framework.web.filter.RateLimiterFilter;
import com.hypersense.boot.framework.security.filter.CaptchaValidationFilter;
import com.hypersense.boot.framework.security.filter.TokenAuthenticationFilter;
import com.hypersense.boot.framework.security.handler.MyAccessDeniedHandler;
import com.hypersense.boot.framework.security.handler.MyAuthenticationEntryPoint;
import com.hypersense.boot.framework.security.provider.SmsAuthenticationProvider;
import com.hypersense.boot.framework.security.token.TokenManager;
import com.hypersense.boot.framework.security.service.SysUserDetailsService;
import com.hypersense.boot.system.service.ConfigService;

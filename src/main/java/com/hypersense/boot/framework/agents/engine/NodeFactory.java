 ...
 * </p>
 * <p>
 * 其它依赖（HitlGateChecker / AgentProperties / ToolProviders / SandboxManager）
...
public class NodeFactory {
    ...
    public PlanNode planNode(ChatModel chatModel) {
        return new PlanNode(chatModel, hitlGateChecker, agentProperties);
    }

    public ExecuteNode executeNode(ChatModel chatModel) {
        return new ExecuteNode(chatModel, hitlGateChecker);
    }

    public FinalizeNode finalizeNode(ChatModel chatModel) {
        return new FinalizeNode(chatModel);
    }

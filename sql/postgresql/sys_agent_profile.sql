...
('design', '设计模式', 'PPT/Landing/信息图等视觉产物，参考 huashu-design 哲学',
 '你是设计专家。遵循反 slop 原则（无紫渐变/无 emoji icon/无 SVG 手画人脸）。资产优先：具名品牌必取官方 logo，内容必需真图必取。Junior Designer 模式：先 demo 后批量。',
